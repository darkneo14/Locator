...
<!-- AddThis Smart Layers END -->
	...
	<ol class="breadcrumb">
			  ...
			  <li class="active">Restaurants</li><br>
				<p class="article-left"><a class="m-green" href="http://localhost/locator/restaurant-listam.php" >Ambiance</a><a class="m-green" href="http://localhost/locator/restaurant-listfd.php">Food</a><a class="m-green" href="http://localhost/locator/restaurant-listsr.php">Service</a><a class="m-orange" href="http://localhost/locator/restaurant-list.php">Overall</a></p>
			</ol><br><br>
	<div class="site-map">
...
?>
		...
		<div class="col-md-4 site-map-left">
			<div class="site-map-links">
				...
				$sid=$row['sid'];   
				   $sql1 =  "SELECT * FROM res WHERE sid = '$sid' ORDER BY urat DESC";
...
{   
 while($row1 = mysql_fetch_assoc($result1)) {
	 $rid=$row1["rid"];
				...
				<a href="http://localhost/locator/restaurant-details.php?rid=<?php echo $rid ?>"><?php echo $row1['rname'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php  echo "   ".$row1['urat'] ?><?span></a>
<?php }} ?>
			</div>
		</div>
<?php } } ?>
