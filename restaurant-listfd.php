            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav"><!--
					...
					<h5 class="movies-page">for places page - <a href="regions.html">Click here</a> </h5>
                                    <div class="col-sm-4">
										<ul class="mov_list">
						<li><a href="movie-single.html">Most Visited Places</a></li>
					</ul>
					<ul class="mov_list">
						<li><a href="movie-single.html">Least Visited Places</a></li>
					</ul>
                                <hr>
					...
					<li class="active dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Restaurants<b class="caret"></b></a>
                        <ul class="dropdown-menu half">
                            <li class="w3_megamenu-content withdesc">
                                <div class="row">
					<h5 class="movies-page">for restaurants page - <a href="restaurant-list.html">Click here</a> </h5>
								<h3 class="title">Featured Restaurants</h3>
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="restaurant-list"><img src="images/restaurants/bangala.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="restaurant-list.html"><img src="images/restaurants/bukhara.jpg" alt=""></a>
								</div>
								<div class="e-buy-tickets">
									<a href="#">Learn More</a>
								</div>
...
<!-- AddThis Smart Layers END -->
	...
	<ol class="breadcrumb">
			  ...
			  <li class="active">Restaurants</li><br>
				<p class="article-left"><a class="m-green" href="http://localhost/Travel%20Best/restaurant-list.php?ss=1" >Ambiance</a><a class="m-green" href="http://localhost/Travel%20Best/restaurant-listfd.php">Food</a><a class="m-green" href="http://localhost/Travel%20Best/restaurant-listsr.php">Service</a><a class="m-orange" href="http://localhost/Travel%20Best/restaurant-list.php">Overall</a></p>
			</ol><br><br>
	<div class="site-map">
...
mysql_select_db("zomato");

//session_start();
//$subregion   = $_SESSION['subregion'];
$subregion   = "delhi ncr";

$sql =  "SELECT DISTINCT sid, title FROM res WHERE LOWER(subregion) = LOWER('$subregion') ";
...
?>
		...
		<div class="col-md-4 site-map-left">
			<div class="site-map-links">
				<h5><?php echo $row['title'] ?></h5>
				<?php

				$sid=$row['sid'];   
				   $sql1 =  "SELECT * FROM res WHERE sid = '$sid' ORDER BY frat DESC";
...
{   
 while($row1 = mysql_fetch_assoc($result1)) {
				...
				<a href="http://localhost/Travel%20Best/restaurant-details.php?rid=<?php echo $rid ?>"><?php echo $row1['rname'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php  echo "   ".$row1['urat'] ?><?span></a>
<?php }} ?>
			</div>
		</div>
<?php } } ?>
