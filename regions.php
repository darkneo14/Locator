...
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Login</button>-->
		...
		<div class="container">
		  <div class="main-content">
			<div class="header">
				<div class="logo">
					<a href="index.php"><h1>Places To Visit</h1></a>
				</div>
				<div class="search">
					<div class="search2">
					  <form>
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav"><!--
                    <li class="active"><a href="index.html">Places</a></li>	
                     Mega Menu -->
					<li class="active dropdown w3_megamenu-fw"><a href="index.php" data-toggle="dropdown" class="dropdown-toggle">Places<b class="caret"></b></a>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="regions">
		...
		<div class="region-grid">
			...
			<div class="cities">
				<a href="movies.php">Tawang</a><a href="movies.php">Ziro</a>
			</div>
			<div class="clearfix">		</div>
		</div>
		<div class="region-grid">
			...
			<div class="cities">
				<a href="movies.html">Chinnamandem</a><a href="movies.html">Gudur</a><a href="movies.html">Guntur</a><a href="movies.html">Jangareddy Gudem</a><a href="movies.html">
				Kakinada</a><a href="movies.html">Kurnool</a><a href="movies.html">MarturParvathipuram</a><a href="movies.html">Rajahmundry</a><a href="movies.html">
				Tenali</a><a href="movies.html">Vijayawada</a><a href="movies.html">Vizag</a><a href="movies.html">Vizianagaram</a>
			</div>
			<div class="clearfix">		</div>
		</div>
		<div class="region-grid">
