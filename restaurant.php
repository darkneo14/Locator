...
$ss="select DISTINCT(subregion) from res ";
$ck=mysql_query($ss);
$kk="select DISTINCT(rname) from res ";
$resn=mysql_query($kk);
?>
...
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Login</button>-->
		...
		<div class="container">
		  <div class="main-content">
			<div class="header">
				<div class="logo">
					<a href="restaurant.php"><h1>Places To Visit</h1></a>
				</div>
				<div class="search">
					<div class="search2">
					  <form>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="main-banner">
		 <div class="banner col-md-8">
			<section class="slider">
				<div class="flexslider">
						<ul class="slides">
						<li>
							<img src="images/restaurants/bukhara.jpg" class="img-responsive" alt="taj"/>
						</li>
						<li>
							<img src="images/restaurants/karim's.jpg" class="img-responsive" alt="Mumbai" />
						</li>
						<li>
							<img src="images/restaurants/indianaccent.jpg" class="img-responsive" alt="Agra" />
						</li>
						<li>
							<img src="images/restaurants/karavalli.jpg" class="img-responsive" alt="Kasol" />
						</li>
				  </ul>
				</div>
			</section>
		 ...
		 <div class="col-md-4 banner-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
                    <div class="fleft">
                        <span class="fleft mr20">Enter the city:</span>
                    </div>
							<select class="list_of_cities" id="region"><option value="">Select Another City</option>
							<?php 
							while($val=mysql_fetch_assoc($ck)){
							?>
							<option style="padding-left: 10px;" value="<?php echo $val['subregion'] ; ?>"><?php echo $val['subregion'] ;?></option>
							<?php } ?>
							</select><br><br>
                    <div class="btn-group btn-group-justified">
                        <a class="btn btn-primary" onclick="region()">Search</a>
						
						<script>
						function region(){
							location.href="restaurant-list.php?region="+(document.getElementById("region").value);
						}
						
						</script>
						
                    </div>
							<h4>Search the restaurant !</h4>
                        <span class="fleft mr20">Name:</span>
							<select class="list_of_cities" id="rest"><option value="">Select Restaurant</option>
							<?php 
							while($val=mysql_fetch_assoc($resn)){
							?>
							<option style="padding-left: 10px;" value="<?php echo $val['rname'] ; ?>"><?php echo $val['rname'] ;?></option>
							<?php } ?>
							</select><br><br>
                    <div class="btn-group btn-group-justified">
                        <a href="restaurant-details.php" class="btn btn-primary">Search</a>
                    </div>
					<h5 class="pre"><i class="fa fa-heart"></i>Most Loved Restaurants :<h5>
					<h6 class="ipre"><a href="#">Karim's, </a> <a href="#"> Barbequeue Nation</a>, <a href="#">Hayaat</a></h6>
			  </div>
			</div>
		   </div>
		  </div>
		 ...
		 <div class="clearfix"></div>
			 ...
			 <ul id="flexiselDemo1">
			<li>
				<a href="movies.html"><img src="images/restaurants/bukhara.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<li>
				<a href="movies.html"><img src="images/restaurants/karim's.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<li>
				<a href="movies.html"><img src="images/restaurants/indianaccent.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<li>
				<a href="movies.html"><img src="images/restaurants/bangala.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<li>
				<a href="movies.html"><img src="images/restaurants/karavalli.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<li>
				<a href="movies.html"><img src="images/restaurants/table.jpg" class="img-responsive zoom-img" alt=""/></a>
		...
		<div class="list-of-movies col-md-8">
			...
			<div class="right-side-bar">
				<div class="top-movies-in-india">
					<h4>Top Visited Restaurants In India</h4>
					<ul class="mov_list">
